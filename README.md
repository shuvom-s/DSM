...
* `--save_path`: Path to save outputs of these methods. The output will be posterior matrix of probabilities corresponding to probability of observing [0, 1, 2] at each SNP for each individual. It will be of dimension [# SNPs x # individuals x 3].
